 ...
 *
 * Пока Claude не подключён, сервер отвечает по правилам — интерфейс тот же,
 * поэтому после появления ключа менять здесь ничего не нужно.
 */
          ...
          <header className="ai-head">
            ...
            <div>
              ...
              <div className="ai-sub">
                {engine === 'claude' ? 'На связи · отвечает ИИ' : 'На связи · отвечает по базе знаний'}
              </div>
            </div>
